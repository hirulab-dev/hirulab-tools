...
tools/
  ...
  make_en_qr.py / make_en_cron.py / make_en_contrast.py
                 それぞれの英語版を日本語版から生成する。
...
`docs/en/` に16本あります（Regex Tester / Character Counter / Color Palette /
...
Cron Expression Explainer / **Contrast Ratio Checker**）。
このうち後半の11本は **日本語版から生成**しており、
